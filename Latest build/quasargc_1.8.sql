...
(
    ...
    CONSTRAINT playerprofile_pk PRIMARY KEY (playerid, gameid),
    CONSTRAINT plprof_game_fk FOREIGN KEY (gameid)
        REFERENCES public.game (gameid) MATCH SIMPLE
        ON UPDATE CASCADE
        ON DELETE CASCADE,
    CONSTRAINT plprof_pl_fk FOREIGN KEY (playerid)
...
ALTER TABLE public.leaderboard
    ADD COLUMN leaderboardrankingtype integer NOT NULL DEFAULT 0;
    
ALTER TABLE public.leaderboard
    ADD COLUMN minentryforranking integer NOT NULL DEFAULT 5;
    
ALTER TABLE public.playerscore
    ADD COLUMN gamesplayed integer NOT NULL DEFAULT 1;
    
ALTER TABLE public.playerscore
    ADD COLUMN calculatedrank integer NOT NULL DEFAULT 0;
    
CREATE INDEX calculatedrankidx
    ON public.playerscore USING btree
    (calculatedrank ASC NULLS LAST)
    TABLESPACE pg_default;
    
CREATE INDEX gamesplayedidx
    ON public.playerscore USING btree
    (calculatedrank ASC NULLS LAST)
    TABLESPACE pg_default;
