...
-- Name: playerscorerank; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW playerscorerank AS
 SELECT playerscore.playerid,
   ...
   FROM playerscore,
    player
  WHERE ((playerscore.playerid = player.playerid) AND (player.playerenabled = true))
  ORDER BY playerscore.score DESC;
