...
public class CustomUserDetailsService extends JdbcDaoImpl {
	...
	@Override
	@Value("SELECT playerusername as username, playerpassword as password, playerenabled::text as enabled FROM player WHERE playerusername = ?")
	public void setUsersByUsernameQuery(String usersByUsernameQueryString) {
		super.setUsersByUsernameQuery(usersByUsernameQueryString);
	}

	@Override
	@Value("SELECT playerusername as username, playerrole as authority FROM player WHERE playerusername = ?")
